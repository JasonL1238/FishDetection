"""
Background Subtraction Module for Fish Detection

This module provides a reusable background subtraction implementation
that can be used across different tracking methods and analysis pipelines.
"""
...
class BackgroundSubtractor:
    """
    A reusable background subtraction class for fish detection.
    
    This class provides methods to create background models from video frames
    and apply background subtraction to individual frames or video sequences.
    """
    ...
    def __repr__(self):
        return (f"BackgroundSubtractor(threshold={self.threshold}, "
